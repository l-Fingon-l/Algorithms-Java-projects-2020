...
public class WordNet 
{
   ...
   public WordNet(String synsets, String hypernyms)
   {
       ...
       RootedDAGCheck rdc = new RootedDAGCheck(Hypernyms);
       if (!rdc.isRootedDAG) throw new IllegalArgumentException(rdc.exception);
   ...
   public static void main(String[] args)
   {
	   ...
	   System.out.println(wordnet.distance("subduedness", "brass_hat"));
	   System.out.println(wordnet.sap("subduedness", "brass_hat"));
   }
}